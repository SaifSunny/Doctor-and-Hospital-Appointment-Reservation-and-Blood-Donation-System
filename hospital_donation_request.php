                        ...
                        <div class="card mx-auto"
                            ...
                            <div class="card-body text-center" style="padding:0 60px;">
                                <table class="table" style="font-size: 14px;">
                                    ...
                                    <tbody>
                                        <?php 
                                            $sql = "SELECT * FROM donation_request WHERE hospital_id = $hos_id";
                                            $result = mysqli_query($conn, $sql);
                                            if($result){
                                                while($row=mysqli_fetch_assoc($result)){
                                                    $donation_id =$row['donation_id'];
                                                    $donner_name=$row['donner_name'];
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="hospital_confirm_donation.php?id=<?php echo $donation_id ?>"style="padding:1px; border-radius:50%"><img src="./images/check.png" alt="" width="30" height="30"></a>
                                                <a href="hospital_delete_donation.php?id=<?php echo $donation_id ?>"style="padding:1px; border-radius:50%"><img src="./images/trash.png" alt="" width="30" height="30"></a>
                                            </td>
                                        </tr>
                                        <?php 
                                                }
