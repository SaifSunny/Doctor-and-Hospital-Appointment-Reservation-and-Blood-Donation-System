                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mx-auto"
                            ...
                            <h4 style="padding:30px;">Manage ICU Bookings</h4>
                            <div class="card-body text-center" style="padding:0 60px;">
                                <table class="table" style="font-size: 14px;">
                                    ...
                                    <tbody>
                                        <?php 
                                            $sql = "SELECT * FROM hospital_booking WHERE hospital_id = '$hos_id' AND book_type='icu'";
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="images/users/<?php echo $user_img?>" style="width:40px;border-radius: 50%;"alt=""></td>
                                            <td><?php echo $user_name ?></td>
                                            <td><?php echo $patient_name ?></td>
                                            <td><?php echo $book_from ?></td>
                                            <td><?php echo $book_to ?></td>
                                            <td>
                                                <button
                                            ...
                                            <td>
                                                <a href="hospital_icu_checkout.php?id=<?php echo $booking_id ?>&hid=<?php echo $hos_id ?>"style="padding:1px; border-radius:50%"><img src="./images/check.png" alt="" width="30" height="30"></a>
                                            </td>
                                        </tr>
                                        <?php 
                                                }
