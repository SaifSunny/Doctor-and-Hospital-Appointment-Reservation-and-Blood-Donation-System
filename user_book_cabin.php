...
if(isset($_POST['submit'])){
  ...
  if(!$query_run->num_rows > 0){
    ...
    VALUES ('$user_id','$id','$image',(SELECT `logo` FROM hospital WHERE hospital_id='$id'),'$username', (SELECT hos_name FROM hospital WHERE hospital_id='$id'), '$name', '$from','$to','cabin', '$phone', '$message')";
    $query_run2 = mysqli_query($conn, $query2);
            
    if ($query_run2) {

      $query3 = "UPDATE Hospital SET cabin = cabin - 1 WHERE hospital_id='$id'";
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="appoinment-wrap mt-5 mt-lg-0 pl-lg-5">
            <h2 class="mb-2 title-color">Book Hospital Cabin</h2>
            ...
            <form id="" class="appoinment-form" method="post" action="">
              ...
              <button class="btn btn-main btn-round-full" type="submit" name="submit">Book Cabin<i
