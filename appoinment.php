...
if(isset($_POST['submit'])){
  ...
  $query = "SELECT * FROM appointment WHERE user_id = '$user_id' AND doc_id = '$id'";
  $query_run = mysqli_query($conn, $query);
  if($query_run->num_rows > 0){
    $query2 = "INSERT INTO appointment(`user_id`,doc_id,user_image,doc_image,`user_name`,doc_name,patient_name, `date`, `time`, contact, `message`)
    VALUES ('$user_id','$id','$image',(SELECT `image` FROM doctors WHERE doc_id='$id'),'$username', (SELECT CONCAT(firstname,' ',lastname) FROM doctors WHERE doc_id='$id'), '$name', '$date','$time', '$phone', '$message')";
          ...
          <div class="appoinment-wrap mt-5 mt-lg-0 pl-lg-5">
            ...
            <form id="" class="appoinment-form" method="post" action="">
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    <input name="time" id="time" type="text" class="form-control" placeholder="Time" required>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                    <input name="name" id="name" type="text" class="form-control" placeholder="Patients Full Name"
                    required>
                  </div>
                </div>
              ...
              <button class="btn btn-main btn-round-full" type="submit" name="submit">Make Appoinment<i
