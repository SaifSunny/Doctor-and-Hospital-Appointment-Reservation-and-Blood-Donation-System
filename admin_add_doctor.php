            ...
            if(!$query_run->num_rows > 0){
                ...
                if( in_array($imageFileType,$extensions_arr) ){
                    ...
                    if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
                        ...
                        $query2 = "INSERT INTO doctors(firstname,lastname,nid,education1,education2,gender,contact,clinic_address,clinic_city,clinic_zip,  username,email,`password`, join_date, `image`,dep_id, dep_name)
                        VALUES ('$firstname','$lastname','$nid','$education1','$education2','$gender','$contact','$address','$city','$zip','$username', '$email', '$password', '$date', '$name','$dep_id',(SELECT dep_name FROM department WHERE dep_id='$dep_id'))";
                                ...
                                <form action="" method="POST" enctype='multipart/form-data'>
                                    ...
                                    <div class="d-flex justify-content-end" style="padding-top:20px;">
                                        <button type="submit" name="submit" class="btn btn-success"
                                            ...
                                            Doctor</button>
                                        <a href="admin_doctors.php" class="btn btn-primary">Go Back</a>
                                    </div>
                                </form>
                            </div>
                        </div>
