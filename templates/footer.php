			...
			<div class="row">
				...
				<div class="col-lg-2 col-md-6 col-sm-6">
					<div class="widget mb-5 mb-lg-0">
						...
						<?php
							$sql = "SELECT * FROM department LIMIT 5";
							...
							if($result){
								while($row=mysqli_fetch_assoc($result)){
									...
									$id=$row['dep_id'];
						?>
							<li><a href="department-single.php?id=<?php echo $id ?>"><?php echo $name?></a></li>
							<?php
									}
								}
							?>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="widget widget-contact mb-5 mb-lg-0">
						...
						<div class="footer-contact-block mb-4">
							...
							<h4 class="mt-2"><a href="tel:+23-345-67890">support@healthhub.com</a></h4>
						</div>
						...
						<div class="footer-contact-block">
							...
							<h4 class="mt-2"><a href="tel:+23-345-67890">+880152-1212122</a></h4>
						</div>
					</div>
				</div>
			</div>
