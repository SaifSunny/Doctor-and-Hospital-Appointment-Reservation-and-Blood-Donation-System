...
<header>
	...
	<nav class="navbar navbar-expand-lg navigation" id="navbar">
		<div class="container">
			<a class="navbar-brand" href="doctor_home.php"><img src="images/logo.png" alt="" class="img-fluid"></a>
			...
			<div class="collapse navbar-collapse" id="navbarmain">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a class="nav-link" href="doctor_home.php">Home</a></li>
					<li class="nav-item"><a class="nav-link" href="doctor_appointment.php">Appointments</a></li>
					<li class="nav-item"><a class="nav-link" href="doctor_patients.php">Patients</a></li>
					<li class="nav-item"><a class="nav-link" href="doctor_history.php">History</a></li>
					...
					<div class="col-2">
						<div class="nav-item dropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
								<li><a class="dropdown-item" href="doctor_profile.php"><i
